...
const Wishlist = () => {
  // ডামি উইশলিস্ট ডাটা (আপনার রিয়েল প্রজেক্টে এটি কনটেক্সট বা গ্লোবাল স্টেট থেকে আসবে)
  const [wishlistItems, setWishlistItems] = useState([
    ...
    },
    {
      ...
      currency: "BDT",
      image: "/jacket.jpg",
      stock: 0, // স্টক আউট কেস দেখানোর জন্য
    }
  ]);
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 className="text-2xl font-black text-slate-950 dark:text-white flex items-center gap-2.5">
              My Wishlist <span className="text-sm font-bold bg-[#C5A059]/10 text-[#C5A059] px-2.5 py-0.5 rounded-full">{wishlistItems.length}</span>
            </h1>
          </div>
