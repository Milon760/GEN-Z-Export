...
const Shop = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans antialiased transition-colors duration-500 pt-20 pb-10 md:pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 text-left">
          {filteredProducts.map((product) => {
            ...
            // ১. চেক করুন প্রোডাক্টটি ফেভারিট লিস্টে আছে কিনা
            const isFavorite = favorites.some(
              (item) => (item._id || item.id) === product._id,
            );

            // ২. চেক করুন প্রোডাক্টটি কার্ট লিস্টে আছে কিনা (আপনার কার্ট স্টেটের নাম অনুযায়ী পরিবর্তন করে নেবেন)
            ...
            return (
              ...
              >
                <div>
                    ...
                    <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 z-10">
                      ...
                      <button
                        ...
                        className={`w-10 h-10 rounded-xl shadow-md flex items-center justify-center active:scale-95 transition-all cursor-pointer border
                         ${
                           isFavorite
                             ? "bg-neutral-950 text-[#e4024d] border-neutral-950 hover:bg-neutral-900" // ফেভারিট থাকলে ব্যাকগ্রাউন্ড ডার্ক কালো এবং হার্ট/বর্ডার গোল্ডেন হবে
                             : "bg-[#C5A059] text-neutral-950 border-[#C5A059] hover:bg-[#C5A059]/90" // নরমাল অবস্থায় আপনার গোল্ডেন কালার
                         }`}
                      >
                        {isFavorite ? (
                          <FaHeart size={16} />
                  ...
                  <div className="space-y-1.5 px-1 mt-">
