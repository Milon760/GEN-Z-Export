  ...
  const [questions, setQuestions] = useState([
    {
      id: 1,
      user: "রাকিব হাসান",
      question: "এটার কালার কি ওয়াশ করলে উঠে যাবে?",
      answer:
        "না ভাইয়া, এটি প্রিমিয়াম কালার ফাস্টনেস গ্যারান্টিযুক্ত ফ্যাব্রিক।",
    },
    {
      id: 2,
      user: "আরিফ আহমেদ",
      question: "ঢাকা সিটির বাইরে ডেলিভারি দিতে কতদিন লাগবে?",
      answer: "ঢাকার বাইরে সাধারণত ২-৩ কার্যদিবসের মধ্যে ডেলিভারি পেয়ে যাবেন।",
    },
  ]);
  ...
  const [reviews, setReviews] = useState([
    {
      ...
      rating: 5,
      comment:
        "অসাধারণ কোয়ালিটি! ঠিক যেমনটা ছবিতে দেখেছি তেমনটাই পেয়েছি। ধন্যবাদ!",
      date: "12 July 2026",
    },
    {
      id: 2,
      user: "জসিম উদ্দিন",
      rating: 4,
      comment: "ফিটিং একদম পারফেক্ট। কাপড়টাও বেশ আরামদায়ক।",
      date: "05 July 2026",
    },
  ]);
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-5 bg-slate-50 dark:bg-zinc-950 text-center">
        <p className="text-lg font-bold text-slate-500 dark:text-zinc-400 mb-4">
          Oops! Product not found.
        </p>
        <Link
          to="/"
          className="flex items-center gap-2 px-5 py-2.5 bg-[#C5A059] text-zinc-950 font-bold text-sm rounded-xl hover:bg-[#b08e4f] transition-all"
        >
  ...
  const handleAskQuestion = (e) => {
    ...
    setQuestions((prev) => [
      ...prev,
      {
        ...
        answer: "আমাদের সাপোর্ট টিম শীঘ্রই আপনার প্রশ্নের উত্তর দিবে।",
      },
    ]);
    setQuestionInput("");
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 pt-28 md:pt-32 pb-16 px-4 md:px-8 transition-colors duration-500">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <Link
          to={-1}
          className="inline-flex items-center gap-2 text-xs font-bold text-slate-600 dark:text-zinc-400 hover:text-[#C5A059] transition-colors mb-2 group"
        >
          <FaArrowLeft
            size={12}
          ...
          <div className="flex flex-col justify-between py-2 space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-baseline gap-3">
                ...
                {product.original_price && (
                  <span className="text-sm font-semibold line-through text-slate-400">
                    {product.original_price} {product.currency || "BDT"}
                  </span>
                )}
              </div>
              ...
              <p className="text-xs md:text-sm text-slate-500 dark:text-zinc-400 leading-relaxed">
                {product.description || "Premium urban fashion clothing item."}
              </p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.colors.map((color) => (
                      ...
                      >
                        {selectedColor === color && <FaCheck size={8} />}{" "}
                        {color}
                      </button>
                    ))}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.sizes.map((size) => (
                      <button
                        ...
                        className={`w-10 h-10 text-xs font-bold rounded-xl border flex items-center justify-center transition-all ${selectedSize === size ? "bg-[#C5A059] border-[#C5A059] text-zinc-950 shadow-md scale-105" : "bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 border-slate-200 dark:border-zinc-800"}`}
                      >
                        {size}
                      </button>
                    ))}
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-xl p-1 shrink-0">
                  <button
                    ...
                    className="p-2 text-slate-500 dark:text-zinc-400 hover:text-[#C5A059] transition-colors"
                  >
                    <FaMinus size={10} />
                  </button>
                  <span className="w-8 text-center text-xs font-bold text-slate-800 dark:text-zinc-200">
                    {quantity}
                  </span>
                  <button
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 bg-zinc-950 dark:bg-zinc-100 text-white dark:text-zinc-950 text-xs font-bold rounded-xl shadow-md disabled:opacity-50"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-5 border border-slate-200/60 dark:border-zinc-800 shadow-sm space-y-4 text-left">
            <h3 className="font-black text-xs sm:text-sm uppercase tracking-wider text-slate-900 dark:text-white flex items-center gap-2 border-b border-slate-100 dark:border-zinc-800 pb-3">
              <FaStar className="text-amber-500" /> Ratings & Reviews (
              {reviews.length})
            </h3>
            ...
            <div className="max-h-64 overflow-y-auto space-y-3 pr-1">
              {reviews.map((rev) => (
                <div
                  key={rev.id}
                  className="p-3 bg-slate-50 dark:bg-zinc-950 rounded-2xl border border-slate-100 dark:border-zinc-800/60 space-y-1"
                >
                  <div className="flex items-center justify-between">
            ...
            <form
              ...
              className="space-y-2 pt-2 border-t border-slate-100 dark:border-zinc-800"
            >
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-slate-50 dark:bg-zinc-950 text-xs font-bold border border-slate-200 dark:border-zinc-800 rounded-lg p-1 focus:outline-none"
                >
                  {[5, 4, 3, 2, 1].map((n) => (
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-xl px-4 py-2.5 text-xs font-semibold focus:outline-none focus:border-[#C5A059]"
                />
                <button
                  type="submit"
                  className="px-4 bg-zinc-950 text-white dark:bg-zinc-100 dark:text-zinc-950 rounded-xl flex items-center justify-center active:scale-95 transition-all"
                >
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-5 border border-slate-200/60 dark:border-zinc-800 shadow-sm space-y-4 text-left">
            <h3 className="font-black text-xs sm:text-sm uppercase tracking-wider text-slate-900 dark:text-white flex items-center gap-2 border-b border-slate-100 dark:border-zinc-800 pb-3">
              <FaQuestionCircle className="text-[#C5A059]" /> Product Q&A Hub (
              {questions.length})
            </h3>
            ...
            <div className="max-h-64 overflow-y-auto space-y-3 pr-1">
              {questions.map((q) => (
                <div
                  key={q.id}
                  className="p-3 bg-slate-50 dark:bg-zinc-950 rounded-2xl border border-slate-100 dark:border-zinc-800/60 space-y-2"
                >
                  <div className="space-y-0.5">
                    <p className="text-xs font-black text-slate-950 dark:text-white flex items-center gap-1.5">
                      <span className="bg-blue-500 text-white text-[9px] px-1 rounded font-black">
                        Q
                      </span>{" "}
                      {q.question}
                    </p>
                    <span className="block text-[9px] text-slate-400 font-bold ml-5">
                      Asked by {q.user}
                    </span>
                  </div>
                  <div className="bg-white dark:bg-zinc-900 p-2 rounded-xl border border-slate-100 dark:border-zinc-800/40 text-xs text-slate-600 dark:text-zinc-300 ml-4 font-medium flex items-start gap-1.5">
                    <span className="bg-emerald-500 text-white text-[9px] px-1 rounded font-black mt-0.5">
                      A
                    </span>
                    <p>{q.answer}</p>
                  </div>
            ...
            <form
              ...
              className="flex gap-2 pt-2 border-t border-slate-100 dark:border-zinc-800"
            >
              <input
                type="text"
                value={questionInput}
        ...
        {otherCategoriesProducts.length > 0 && (
          <div className="space-y-6 pt-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
              {otherCategoriesProducts.map((product) => {
                ...
                return (
                  <div
                    key={productId}
                    className="group bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800/80 rounded-3xl p-3.5 space-y-4 hover:border-[#C5A059]/40 dark:hover:border-[#C5A059]/30 hover:shadow-[0_20px_50px_rgba(0,0,0,0.03)] dark:hover:shadow-[0_15px_40px_rgba(0,0,0,0.4)] transition-all duration-500 relative flex flex-col justify-between text-left"
                  >
                    <div>
                      {/* Product Image & Badges */}
                      <div className="relative aspect-[4/5] bg-slate-100 dark:bg-zinc-950 rounded-2xl overflow-hidden border border-slate-200/30 dark:border-zinc-800/30">
                        {hasDiscount && (
                        ...
                        {product.stock <= 0 && (
                          <span className="absolute inset-0 z-10 bg-zinc-950/60 backdrop-blur-[2px] text-white font-black text-xs tracking-widest uppercase flex items-center justify-center">
                            OUT OF STOCK
                          </span>
                        )}
                        ...
                        <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 z-10">
                          <Link
                            to={`/shop/category/${product.category}/${product.id}`}
                            className="w-10 h-10 rounded-xl bg-white dark:bg-zinc-900 text-slate-900 dark:text-white shadow-md border border-slate-200/40 dark:border-zinc-800/60 flex items-center justify-center hover:text-[#C5A059] transition-colors"
                          >
                            <FiEye size={15} />
                          </Link>
                          ...
                          <button
                            ...
                            className={`w-10 h-10 rounded-xl shadow-md flex items-center justify-center active:scale-95 transition-all cursor-pointer border ${
                              isFavorite
                                ? "bg-zinc-950 text-[#e4024d] border-zinc-950 hover:bg-zinc-900"
                                : "bg-[#C5A059] text-zinc-950 border-[#C5A059] hover:bg-[#C5A059]/90"
                            }`}
                          >
                            {isFavorite ? (
                              <FaHeart size={16} />
                          ...
                          <button
                            ...
                            disabled={product.stock <= 0}
                            className="w-10 h-10 rounded-xl bg-[#C5A059] text-zinc-950 shadow-md flex items-center justify-center hover:bg-[#C5A059]/90 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 transition-all cursor-pointer"
                          >
                      ...
                      <div className="space-y-1.5 px-1 mt-3">
                        ...
                        <Link to={`/shop/${productId}`}>
                          <h3 className="font-black uppercase text-xs sm:text-sm tracking-tight text-slate-900 dark:text-white line-clamp-1 group-hover:text-[#C5A059] transition-colors duration-300">
                            {product.name}
                          </h3>
                        </Link>

                        <p className="text-[11px] text-slate-400 dark:text-zinc-500 font-medium line-clamp-1">
                          {product.description ||
                            "Premium street culture wear compilation."}
                        </p>
                      </div>
                    </div>

                    {/* Pricing Section */}
                    <div className="pt-2 mt-2 border-t border-slate-100 dark:border-zinc-800/60 flex items-baseline justify-between px-1">
                      <div className="flex items-baseline gap-2">
                        <span className="font-black text-sm sm:text-base text-slate-900 dark:text-white">
                          {product.price} {product.currency || "BDT"}
                        </span>
                        {hasDiscount && (
                          <span className="font-bold text-xs text-slate-400 dark:text-zinc-500 line-through">
                            {product.original_price}
                          </span>
                        )}
                      </div>
