    ...
    <div className="w-full bg-white dark:bg-zinc-950 text-neutral-900 dark:text-neutral-100 min-h-screen pt-24 font-sans selection:bg-[#C5A059] selection:text-black">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex justify-between items-end mb-8">
          ...
          <Link
            to="/shop"
            className="text-xs font-black tracking-widest uppercase text-cyan-600 dark:text-[#C5A059] flex items-center gap-2 hover:underline"
          >
          ...
          {featuredProducts.length > 0
            ? featuredProducts.map((product) => (
                ...
                >
                  ...
                  <h3 className="font-bold text-sm sm:text-base text-neutral-800 dark:text-white truncate">
                    {product.title}
                  </h3>
                  <p className="text-xs text-neutral-500 line-clamp-1 mt-0.5">
                    {product.description}
                  </p>
                  <span className="font-black text-sm text-cyan-600 dark:text-[#C5A059] mt-1">
                    ${product.price}
                  </span>
                </div>
              ))
