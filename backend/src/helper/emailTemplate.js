                        ...
                        <tr>
                            <td class="inner-padding" style="padding: 48px 40px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <!-- OTP DISPLAY BOX WITH AUTO-SELECT -->
                                    <tr>
                                        <td align="center" style="padding-bottom: 28px;">
                                            <table class="otp-box" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #141416; border: 1px dashed #27272a; border-radius: 16px; text-align: center;">
                                                <tr>
                                                    <td style="padding: 20px 10px 8px 10px;">
                                                        <span class="otp-code selectable-code" style="font-family: 'Courier New', Courier, monospace; font-size: 34px; font-weight: 800; color: #C5A059; letter-spacing: 8px; display: inline-block; cursor: pointer;">
                                                            ${otp}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-bottom: 16px;">
                                                        <span style="font-size: 11px; color: #64748b; font-weight: 600; letter-spacing: 0.5px; text-transform: uppercase;">
                                                            👆 Tap or click to select code
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>
